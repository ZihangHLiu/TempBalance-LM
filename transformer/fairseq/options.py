...
def add_norm_args(parser):
    ...
    parser.add_argument('--encoder-norm-self', default='layer',
                                choices=['layer', 'group', 'batch', 'instance', 'inslayer', 'switch', 'btgroup', \
                                         'rebatch', 'clipswitch', 'mode', 'remode', 'amm', 'pos', 'mabatch'],
                                help='normalization scheme for encoder')
    parser.add_argument('--encoder-norm-ff', default='layer',
                        choices=['none', 'layer', 'group', 'batch', 'instance', 'inslayer', 'switch', 'btgroup', \
                                 'rebatch', 'clipswitch', 'mode', 'remode', 'amm', 'pos', 'mabatch'],
                        help='normalization scheme for encoder')
    parser.add_argument('--encoder-spec-norm', default=False, action='store_true')
    parser.add_argument('--decoder-norm-self', default='layer',
                            choices=['layer', 'group', 'batch', 'instance', 'inslayer', 'switch', 'btgroup', \
                                     'rebatch', 'clipswitch', 'mode', 'remode', 'amm', 'mabatch'],
    ...
    group.add_argument('--dropout-type', default='none',
                        choices=['none', 'bernoulli', 'gamma', 'gumbel', 'beta', 'laplace', 'chi', \
                                 'normal'],
                        help='droptypes for all the layers')
    group.add_argument('--dropout-gama',  default=0.5, type=float, metavar='N',
                       help='dropout gama for some noisy types')
    group.add_argument('--fix-fingers',  default='xmin_mid', type=str, help='fix_fingers')

    group.add_argument('--xmin-pos',  default=2, type=float, help='fix fingers')

    group.add_argument('--filter-zeros',  default='False', type=str, help='')

    group.add_argument('--temp-balance-lr',  default='tb_linear_map', type=str, help='')

    group.add_argument('--batchnorm',  default='True', type=str, help='')

    group.add_argument('--lr-min-ratio',  default=0.6, type=float, help='')

    group.add_argument('--lr-slope',  default=0.8, type=float, help='')

    group.add_argument('--metric',  default='alpha', type=str, help='')

    group.add_argument('--tb',  default='False', type=str, help='')

    group.add_argument('--tbr-after-warm',  default='True', type=str, help='')

    group.add_argument('--esd-interval', default=500, type=int, help='')
    
    group.add_argument('--tb-interval', default=500, type=int, help='')

    group.add_argument('--acc-v', default='False', type=str, help='')

    group.add_argument('--acc-mid', default='False', type=str, help='')
    
    group.add_argument('--acc-block', default='False', type=str, help='')
    
    group.add_argument('--lr-scale', default=1.0, type=float, help='')
    # fmt: on
    return group
...
def add_optimization_args(parser):
    ...
    # parser.add_argument('--adamhess-version', default='v2',
                    # help='adamhess version')
    group.add_argument('--single-gpu', default=False, action='store_true',
                        help='single gpu setting')
    # fmt: on
    return group
...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--early-stop', default=10000, type=int)
    # fmt: on
    return group
