...
echo running group tb with lr_scale $lr_scale

OUTPUT_PATH=/data/yefan0726/checkpoints/zihang/checkpoints/nlp/mt/${PROBLEM}/adam_group_tb/${ARCH}_${PROBLEM}_seed${SEED}/lr_scale_${lr_scale}_metric_${metric}
NUM=5
mkdir -p $OUTPUT_PATH
