...
OUTPUT_PATH=/data/yefan0726/checkpoints/zihang/checkpoints/nlp/mt/${PROBLEM}/adam_tb/${ARCH}_${PROBLEM}_seed${SEED}/after_warmup_${tbr_after_warm}_${temp_balance_lr}_${metric}_interval_${tb_interval}/min_${lr_min_ratio}_slope${lr_slope}_${fix_fingers}_mid_pos${xmin_pos}
NUM=5
mkdir -p $OUTPUT_PATH
