...
OUTPUT_PATH=/scratch/tpang/zhliu/checkpoints/nlp/mt/${PROBLEM}/adam_cross_acc_v/${ARCH}_${PROBLEM}_seed${SEED}/min_${lr_min_ratio}_slope${lr_slope}
NUM=5
mkdir -p $OUTPUT_PATH
...
#         --tb False \
#         --acc-v ${acc_v} --tbr-after-warm ${tbr_after_warm} --temp-balance-lr ${temp_balance_lr} --metric ${metric} \
